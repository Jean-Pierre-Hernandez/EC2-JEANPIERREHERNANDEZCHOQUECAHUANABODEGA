...
import com.idat.EC2JEANPIERREHERNANDEZCHOQUECAHUANABODEGA.service.ClienteService;
...
public class ClienteController {
	...
	public ResponseEntity<Void> actualizar(@RequestBody ClienteDTORequest cliente){
		ClienteDTOResponse c = service.obtenerClienteId(cliente.getIdClienteDTORe());
		if (c != null) {
